...
<div class="login-container">
    ...
    <footer class="footer">
        <p>Don't have an account? <a href="<?php echo e(route('register')); ?>" class="category-list">Register</a></p>
    </footer>

</body>
</html>
<?php /**PATH C:\xampp\htdocs\final-project-01-main1\resources\views/auth/login.blade.php ENDPATH**/ ?>